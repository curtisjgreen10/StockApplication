...
<script runat="server">
        protected void lst_to_symbol_SelectedIndexChanged(object sender, EventArgs e)
        {
            txt_chosen_curr_to.Text = lst_to_symbol.SelectedValue;
        }

        protected void lst_from_symbol_SelectedIndexChanged(object sender, EventArgs e)
        {
            txt_chosen_curr_from.Text = lst_from_symbol.SelectedValue;
        }
</script>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <span style="display:block; height: 5px; width: 50px;"></span>
            <asp:ListBox id="lst_from_symbol" style="Z-INDEX: 101; LEFT: 301px; OVERFLOW:scroll;  TOP: 286px; " runat="server" TextMode="MultiLine" Height="321px" Width="162px" OnSelectedIndexChanged="lst_from_symbol_SelectedIndexChanged" AutoPostBack="True"></asp:ListBox>
            <span style="display:inline-block; width:100px;"></span>
            <asp:ListBox id="lst_to_symbol" style="Z-INDEX: 101; LEFT: 301px; OVERFLOW:scroll;  TOP: 286px; " runat="server" TextMode="MultiLine" Height="321px" Width="162px" OnSelectedIndexChanged="lst_to_symbol_SelectedIndexChanged" AutoPostBack="True"></asp:ListBox>
            <span style="display:block; height: 5px; width: 50px;"></span>
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
            <asp:Textbox ID="txt_chosen_curr_from" runat="server"  BorderColor="Yellow" BorderStyle="Solid" ReadOnly="True"></asp:Textbox> 
            <span style="display:inline-block; width:100px;"></span>
            <asp:TextBox ID="txt_chosen_curr_to" runat="server"  BorderColor="Yellow" BorderStyle="Solid" ReadOnly="True"></asp:TextBox> 
            <asp:Label ID="lbl_select_curr_error" runat="server" ForeColor="Red" Text=""></asp:Label>
            </ContentTemplate>
            <Triggers>
                <asp:AsyncPostBackTrigger ControlID="lst_from_symbol" />
                <asp:AsyncPostBackTrigger ControlID="lst_to_symbol" />
            </Triggers>
            </asp:UpdatePanel>
            <span style="display:block; height: 5px; width: 50px;"></span>
